...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=  ROOT /'data/testimages', help='file/dir/URL/glob, 0 for webcam')
    ...
    parser.add_argument('--name', default='plate', help='save results to project/name')
